                        ...
                        <div className="card-body academic-info">
                            <div className="mb-4 d-flex align-items-center justify-content-between">
                                <h5 className="fw-bold mb-0 me-4">
                                    ...
                                    <span className="fs-12 fw-normal text-muted text-truncate-1-line">Faculty member's academic details and qualifications</span>
                                </h5>
                                <button type="button" className="btn btn-sm btn-primary">Save</button>
                            </div>
                            <div className="row mb-4 align-items-center">
                            ...
                            <div className="row mb-4 align-items-center">
                                ...
                                <div className="col-lg-8">
                                    <SelectDropdown
                                        ...
                                        selectedOption={selectedOption}
                                        defaultSelect="assistant-professor"
                                        onSelectOption={(option) => setSelectedOption(option)}
                                    />
                                </div>
                            </div>
                            ...
                            <TextArea
                                ...
                                labelId={"researchInterestsInput"}
                                placeholder={"Brief description of research interests and ongoing projects"}
                                row='4'
                            />
                        </div>
                    </div>
